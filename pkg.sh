clear
echo "
                   Termux  Full Command Setup

  ____   _____  _____    _____ ______ _______ _    _ _____  
...
" | lolcat
echo "=========================================" | lolcat
echo "   Tools Name : Basic Pkg Install" | lolcat
echo "   Author : Shawon Islam Saim" | lolcat
echo "   Fb Group : Bangladesh Cyber Squad" | lolcat
echo "   Github   : github.com/TEAMBCS" | lolcat
echo " Frist press y And Enter if No run press y" | lolcat
echo "=========================================="
...
echo "All Package Installed" | lolcat
echo " Stay with 🇹🇪🇦🇲 🇧🇨🇸Thanks" | lolcat
